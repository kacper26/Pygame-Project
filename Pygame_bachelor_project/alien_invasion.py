...
class AlienInvasion:
    ...
    def run_game(self):
        ...
        # Oczekiwanianie na podjęcie akcji - naciśnięcie klawisza lub przycisku myszy
        while True:
            clock.tick(200)
            self._check_events()
    ...
    def _check_play_button(self, mouse_pos):
        ...
        # Rozpoczęcie nowej gry po kliknięciu przycisku "Graj".
    ...
    def _check_keydown_events(self, event):
        ...
        # Zakończenie procesu działania gry poprzez wciśnięcie klaiwsza Q:
    ...
    def _create_fleet(self):
        ...
        # Ustalenie, ile rzędów obcych mieści się na ekranie.
    ...
    def _update_screen(self):
        ...
        # Odświeżenie ekranu w trakcie każdej iteracji pętli. Uaktualnienie obrazów na ekranie i przejście do nowego ekranu.
        ...
        # Wyświetlnie ostatnio zmodyfikowanego ekranu.
        pygame.display.flip()
